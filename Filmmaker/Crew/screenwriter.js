...
function generateScript(prompt, filePath) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _getDummyScriptFromServer(prompt)]; //TODO: Actually call server
                case 1:
                    script = _a.sent() //TODO: Actually call server
                    ;
                    return [4 /*yield*/, writeScriptToDisk(prompt, filePath)];
                case 2:
                    _a.sent();
