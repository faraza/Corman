...
var audiotimeline_1 = require("./audiotimeline");
var videotimeline_1 = require("./videotimeline");
/**
...
function createMovie(assets) {
    return __awaiter(this, void 0, void 0, function () {
        var audioTimeline, videoTimeline;
...
function animateAndMix(audioTimeline, videoTimeline, assets) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: //TODO: Rename this
                return [4 /*yield*/, animateVideoTimeline(videoTimeline, assets)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, addAudioToAnimatedVideo(audioTimeline, assets)];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
